...
class ProfileCreationForm(UserCreationForm):
    date_of_birth = DateField(required = True, widget=SelectDateWidget(years=range(1920, datetime.date.today().year)), initial=datetime.date.today()) # datetime shows a range of values from 1920 - current year

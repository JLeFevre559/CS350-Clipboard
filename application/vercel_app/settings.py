...
ALLOWED_HOSTS = ['127.0.0.1', '.vercel.app', 'testserver', 'clipboard-unco-cs350.vercel.app'] 
...
AUTH_USER_MODEL = 'example.Profile'
...
LOGIN_REDIRECT_URL = 'home'  # URL name for the home view (where users are redirected after login)